            ...
            if($pro_qty>0){
				...
				<div class='col-md-3' >
							<div class='panel panel-info'>
								...
								<div class='panel-heading panelsiam' >$$pro_price.00
        ...
        if(isset($_POST["cart_checkout"])){
            echo "<div class='row'>
				...
				<div class='col-md-4'>
					...
					<input style='float: left' type=\"radio\" name=\"cashondelivery\"  checked=\"checked\" value=\"Cash On Delivery\"> <p style='padding-left: 10px'>   Cash On Delivery</p><br>
					<form method=\"post\">
