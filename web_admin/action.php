			...
			<div class='col-md-3' >
							<div class='panel panel-info'>
								...
								<div class='panel-body'>
									<img src='product_images/$pro_image' class='col-md-3' style='width:300px; height:300px;'/>
								</div>
								<div class='panel-body' style='height: 112px' >$pro_title
								<br>
								$$pro_price.00
								<a href='updateproduct.php?ido= $pro_id'> <button pid='$pro_id' style='float:right;' id='updateproductid' class='btn btn-danger btn-xs'>Update</button></a>
									<a href='deleteproduct.php?ido= $pro_id'> <button pid='$pro_id' style='float:right;' id='deleteproductid' class='btn btn-danger btn-xs'>Delete</button></a>
								</div>
				...
				<!--<div class='col-md-3'>
							<div class='panel panel-info'>
								<div class='panel-heading'>$pro_title($pro_qty pcs)</div>
								<div class='panel-body'>
